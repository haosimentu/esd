...
<head>
	...
	<script type="text/javascript" src="<%=basePath%>js/pipeline.js"></script>
...
<div class="ny-container">
	<div style="height:48px; line-height:40px; margin:0 60px;">
		<span style="padding:10px;"><label>流水线：</label><input type="text" value="" class="input_on" placeholder="流水线名称或编号" id="keyword"/></span>
		<span style="padding:10px;"><button class="btn btn-default" type="button" id="searchPipeline"> 搜索流水线</button></span>
		<span style="float:right;"><button type="button" class="btn btn-default" id="addPipeline"> 添加流水线</button></span>
	</div>
